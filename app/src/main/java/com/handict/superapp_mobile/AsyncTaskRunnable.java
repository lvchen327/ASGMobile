...
{
    public static final String TAG = "Unity AsyncTaskRunnable";
    //主线程的activity
...
//初始化下拉菜单的通知信息
        ...
        mNotification.icon = R.drawable.mm_submenu_normal;//设置下载进度的icon
    ...
    public void run() {//通过判断不同的状态：更新中/下载失败/下载成功 更新下拉菜单的通知信息
        switch (mStatus) {
            ...
            case AsyncTaskUtil.NOTIFICATION_PROGRESS_UPDATE://更新中
                ...
                String progress = mSize + "";
                if (progress.matches("^\\d+$$")) {
