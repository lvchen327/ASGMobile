...
{
    public static final String TAG = "Unity AsyncTaskUtil";
    ...
    protected Boolean doInBackground(String... params) {
        ...
        try {
            ...
            Log.d(TAG, "folder path is : " + getFolderPath());
            ...
            while ((len = is.read(buff)) != -1) {
                ...
                UnityPlayer.UnitySendMessage("MenuePrefab","GetSize",format.format(MainActivity.getInstance().size)+"");

                if ((MainActivity.getInstance().size + "").matches("^\\d+$$")) {
        ...
        //下载成功
        Log.d(TAG, "DownLoad Success Here!");
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (result) {
            Log.d(TAG, "DownLoad Completed and send Message");
